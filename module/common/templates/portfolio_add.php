      ...
      <div class="box_2_add">
          ...
          <?php 
            ...
            foreach ($cat_array as $key=>$val): 
              if ($val):
          ?>
                <input type="checkbox" id="catidarray" name="catidarray[]" value="<?php echo $key;?>" <?php echo ($selected_cat_array && in_array($key, $selected_cat_array))?'checked="checked"':'';?> />&nbsp;<span class="font4"><?php echo $val;?></span> 
