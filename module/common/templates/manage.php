  ...
  <div class="task_2" style=" overflow:auto;">
    ...
    <table width="895" border="0" align="left" >
      ...
      <tr class="tr<?php echo ($tmp_count%3)?>">
        ...
        <td class="flash_03">
        	<a href="<?php echo urlForAdmin($module.'/edit')?>?id=<?php echo $row_data[id].$page_controlling_value?>"><img src="<?php echo getConfigValue('media_url')?>images/b_edit.png" border="0"></a>
        </td>
        <td class="flash_03">
