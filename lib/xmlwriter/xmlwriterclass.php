 ...
 *
 * @(#) $Id: xmlwriterclass.class,v 1.35 2007/09/17 21:00:20 mlemos Exp $
 *
 */
...
class xml_writer_class
{
	...
	{
		$inputencoding=strtolower($this->inputencoding);
		if(!strcmp($inputencoding,strtolower($this->outputencoding)))
		...
		else
		{
			...
			{
				case 'utf-8':
					if(!strcmp($inputencoding,'iso-8859-1'))
					{
