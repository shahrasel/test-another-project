...
$GONX["header"] = '
<!-- <style type="text/css" media="screen">@import "mysqlbackup/dbrestore.css";</style> -->
<link href="'.getConfigValue('base_url').'module/DataManager/mysqlbackup/dbrestore.css" rel="stylesheet" type="text/css"/>
...
// Home page content
$GONX['homepage'] = "<b>".$GONX["title"]."</b> <br/>
